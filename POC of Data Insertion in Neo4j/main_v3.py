...
start_time = time.time()
subprocess.run([sys.executable, "neo4j_insertion_v3.py" , "User_Group.csv" ,"relation"])
subprocess.run([sys.executable, "neo4j_insertion_v3.py" , "User_Message.csv" ,"relation"])
subprocess.run([sys.executable, "neo4j_insertion_v3.py" , "User_Person.csv" ,"relation"])
