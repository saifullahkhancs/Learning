...
# and class D inherit from bith the class B and C .
...
# Method Resolution Order (MRO)
# When you inhert from the multiple classes , if theire method name
...
# the __init__ method is often refered to as double undersore  inti 
#  or "" dunder intit"" for it has two underscors  on each side of its name.

# *********** dunder methods like  __init__ ,___new__  ****************

# these double underscore on both sides  of init impy that the method is 
...
# alll instances of a class, while instance variable are usefull for storing 
# unique values for each object created from the class.

# a clas variable is defined within a class and outside of any class method.
