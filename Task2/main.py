...
# subprocess.run([sys.executable, "neo4j_insertion.py", "Group.json", "node"])
# subprocess.run([sys.executable, "neo4j_insertion.py", "Message.json", "node"])
...
start_time = time.time()
# subprocess.run([sys.executable, "neo4j_insertion.py", "User_Group.json", "type"])
# subprocess.run([sys.executable, "neo4j_insertion.py", "User_Message.json", "type"])
