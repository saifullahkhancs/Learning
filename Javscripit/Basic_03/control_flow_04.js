...
//        in JavaScript, there are certain values that are considered "truthy" and "falsy" when evaluated in a boolean context.
...
//    -0  is a falsy value in JavaScript. It is considered equal to 0 when compared using the == operator,
//        but it is not equal to 0 when compared using the === operator because they are of different types (number and string). When evaluated in a boolean context, -0 is considered false. For example:

//      big int 0n is a falsy value in JavaScript. It is considered equal to 0 when compared using the == operator,
//            but it is not equal to 0 when compared using the === operator because they are of different types (bigint and number). When evaluated in a boolean context, 0n is considered false. For example:


// truthy values 
// "0" , "false" , "null" , "undefined" , "NaN" , [] , {} , function(){} are all truthy values in JavaScript. 
// They are considered true when evaluated in a boolean context. For example:
...
// object.keys() method is used to get an **array** of the keys of an object, 
